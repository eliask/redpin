/**
 * Filename: GetLocationHandler (in org.redpin.server.standalone.net) This file
...
public class GetLocationHandler implements IHandler {
    ...
    public Response handle(JsonElement data) {
        ...
        log.log(Level.FINER, "got measurement: {0}", data);
        ...
        if (loc == null) {
            ...
            log.log(Level.FINER, "location found: {0} accuracy: {1}", new Object[]{loc, loc.getAccuracy()});
        }
