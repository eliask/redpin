/**
 * Filename: RequestHandler.java (in org.redpin.server.standalone.net) This file
...
public class RequestHandler {
    ...
    public String request(String request) {
        ...
        try {
            ...
            Log.getLogger().log(Level.FINE, "json parse error: {0}", e.getMessage());
        } catch (Exception e) {
            response = new Response(Status.failed, e.getMessage(), null);
            Log.getLogger().log(Level.FINE, "error: {0}", e.getMessage());
        }
        ...
        try {
            ...
            Log.getLogger().log(Level.FINE, "json serializaion error: {0}", e.getMessage());
        }
