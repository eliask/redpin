/**
 * Filename: Categorizer.java (in org.redpin.server.standalone.svm) This file is
...
public class Categorizer {
    ...
    protected Hashtable<String, Integer> categoryToIdDictionary = new Hashtable<>();
    protected Integer ID = 0;
    private final Hashtable<Integer, String> idToCategoryDictionary = new Hashtable<>();
