/**
 * Filename: TrainSVMTimerTask.java (in org.redpin.server.standalone.svm) This
...
public class TrainSVMTimerTask extends TimerTask {
    ...
    private static long getTrainRate() {
